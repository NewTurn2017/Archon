---
description: Prime agent with HarneesLab workflow engine context
---
...
to workflows, case-insensitive matching, `harneeslab-assist` fallback, Codex tool bypass detection.
...
!`ls .harneeslab/workflows/ 2>/dev/null || echo "(none in repo root)"`
...
### DAG Node Types
- `command:` — named command file from `.harneeslab/commands/`

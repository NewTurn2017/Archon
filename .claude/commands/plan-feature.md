---
description: Create a comprehensive implementation plan for an HarneesLab feature
argument-hint: <feature-name-or-description>
---

# Plan Feature: Comprehensive HarneesLab Implementation Planning

## Objective

Produce a detailed, actionable implementation plan for: **$ARGUMENTS**

The plan will be saved to `.claude/harneeslab/plans/{kebab-case-name}.md` and is designed to be
...
Generate the implementation plan at `.claude/harneeslab/plans/{kebab-case-feature-name}.md`:
...
## Affected Packages
- `@harneeslab/{package}` — {what changes}
...
- `import * as core from '@harneeslab/core'` — use named imports
...
1. Save the plan file to `.claude/harneeslab/plans/{kebab-case-name}.md`

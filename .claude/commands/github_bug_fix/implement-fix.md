...
- Maintain HarneesLab coding conventions (see CLAUDE.md)
...
**Important HarneesLab test patterns:**
...
- Follow HarneesLab coding standards exactly (CLAUDE.md + relevant .claude/rules/)

...
mkdir -p .harneeslab/ralph/{feature-slug}
```

### 파일 1: prd.md

**Output path**: `.harneeslab/ralph/{feature-slug}/prd.md`
...
**Output path**: `.harneeslab/ralph/{feature-slug}/prd.json`
...
| File | Purpose |
|------|---------|
| `.harneeslab/ralph/{feature-slug}/prd.md` | Full context - goals, UX, technical patterns |
| `.harneeslab/ralph/{feature-slug}/prd.json` | Story tracking - passes/fails per story |
...
1. **Full PRD** (`.harneeslab/ralph/{feature-slug}/prd.md`) - Goals, persona, UX, technical patterns
2. **Current Story** - From `.harneeslab/ralph/{feature-slug}/prd.json` with acceptance criteria
3. **Previous Learnings** - From `.harneeslab/ralph/{feature-slug}/progress.txt`
...
# Initialize progress
echo "# Ralph Progress Log\nStarted: $(date)\n---" > .harneeslab/ralph/{feature-slug}/progress.txt

# Run Ralph - specify the feature directory
@HarneesLab run ralph .harneeslab/ralph/{feature-slug}
```
```

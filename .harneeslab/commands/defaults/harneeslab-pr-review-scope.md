...
```bash
# Option 1: Plan-based workflow (harneeslab-plan-to-merge)
ls -t $ARTIFACTS_DIR/../runs/*/plan-context.md 2>/dev/null | head -1

# Option 2: Issue-based workflow (harneeslab-fix-github-issue)
...
Then re-request the review: `@harneeslab review this PR`
```

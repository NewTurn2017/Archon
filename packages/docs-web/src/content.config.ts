...
/**
 * Extended docs schema for HarneesLab documentation.
 *
  ...
  docs: defineCollection({
    ...
    schema: docsSchema({
      extend: z.object({
        ...
        /**
         * Book of HarneesLab part — groups chapters into narrative sections.
         ...
         *
         * - user: End users running HarneesLab workflows
         * - developer: People building on or contributing to HarneesLab
         * - operator: People deploying and maintaining HarneesLab
         */

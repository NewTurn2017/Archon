...
describe('calculatePortOffset', () => {
  it('should calculate consistent hash-based offset for worktree paths', () => {
    const testPath = '/Users/test/.harneeslab/worktrees/owner/repo/issue-123';
  ...
  it('should produce different offsets for different worktree paths', () => {
    const path1 = '/Users/test/.harneeslab/worktrees/owner/repo/issue-123';
    const path2 = '/Users/test/.harneeslab/worktrees/owner/repo/issue-456';
  ...
  it('should keep offset in 100-999 range for various paths', () => {
    const testPaths = [
      '/.harneeslab/worktrees/repo/branch',
      '/home/user/.harneeslab/worktrees/owner/repo/issue-1',
      '/very/long/path/to/harneeslab/worktrees/organization/repository/feature-branch-with-long-name',
